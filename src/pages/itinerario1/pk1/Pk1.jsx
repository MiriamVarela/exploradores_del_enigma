...
function Pk1(){
    ...
    return (
        <div className='pk1'>
            ...
            <QuizCard quiztext='Gulliver es un parque para que niños y mayores se diviertan explorando y escalando el gigante mediante escaleras, cuerdas y toboganes. ¿Cuántos toboganes puedes contar?' questionId={1} /> 

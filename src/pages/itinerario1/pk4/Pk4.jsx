...
function Pk4(){
    ...
    return (
        <div className='pk1'>
            ...
            <QuizCard quiztext='La Playa de la Malvarrosa lleva su nombre en honor a la famosa novela "Blancaflor y Filomena", escrita por el poeta valenciano Vicente Blasco Ibáñez. Malvarrosa es el nombre de una de las protagonistas, una joven noble valenciana. ¿En qué año fue la novela publicada? Suma todas las cifras.' questionId={4}/>

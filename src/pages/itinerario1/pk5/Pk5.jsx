...
function Pk5(){
    ...
    return (
        <div className='pk1'>
            ...
            <QuizCard quiztext=' En el Barrio del Carmen de Valencia, la "Casita del Gato" es una pequeña estructura que se asemeja a una gatera o una pequeña casa para gatos. Se trata de una instalación artística curiosa y única que ha capturado la imaginación de los visitantes. Encima del muro dónde se encuentra la casita puedes ver una escultura. ¿Qué figura representa?' questionId={5}/>
